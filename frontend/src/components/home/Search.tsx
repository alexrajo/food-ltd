      ...
      <div className='bg-white flex items-center'>
        {isLoading && (
          <img
            alt='loading spinner'
            src={loadingIcon}
            className='w-8 bg-transparent animate-spin'
          />
        )}
      </div>
      <button
        type='button'
        onClick={onSearch}
        className='w-14 h-14 flex items-center justify-center rounded-r-xl bg-stone-400 cursor-pointer hover:bg-stone-300'
      >
